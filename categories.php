<?php
	...
	$categories = array("Лаптопи", "Таблети","Монитори","Дискове","Flash памети","Телефони","Принтери","Консумативи",
						"Аксесоари","Десктоп компютри","Работни станции","Скенери","Мрежови продукти","Памети","Фотоапарати",
						"Видео карти","Процесори", "Проектори","UPS устройства","Дънни платки","Сървъри","Вентилатори",
						"Кутии", "Захранващи модули", "Контролери и кабели", "Софтуер", "Сториджи", "Оптични устройства", 
						"Допълнителна гаранция", "Смарт часовници");
	$subCategories = array(
