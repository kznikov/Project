...
<main id="profile">
	<nav>
		<h4><img alt="user" src="./assets/images/user.png"/><span>Профил</span></h4>
		<hr/>
		<ul>
	...
	<section>
		...
		<article>
			<div>
				<h3>Информация за контакт<a id="edit" href="./edit.php">Редактирай</a></h3>
				<hr/>
				<p><?= $userRow['name'].$userRow['lastname']?><br/><?= $userRow['email'] ?></p>
				<a href="./edit.php">Промени парола</a>
			</div>
			<div>
				<h3>Бюлетини<a id="edit" href="./newsletter.php">Редактирай</a></h3>
				<hr/>
		...
		<h3>Плащане и доставка<a id="edit" href="./shipping.php">Редактирай</a></h3>
		<hr/>
