	...
	<section class="creat_sec">
		...
		<form id="personal_data" action="" method="post">
			...
			<div class="floated">
				...
				<input id="creat_confpass" type="password" name="confpass"/>
				<span class="error">Това поле е задължително.</span>
			</div>
			<div id="creat_submit">
