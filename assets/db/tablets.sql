...
--
-- Схема на данните от таблица `tablets`
--

INSERT INTO `tablets` (`Id`, `Размер на екрана`, `Дисплей (описание)`, `Резолюция на дисплея`, `Процесор (марка)`, `Процесор`, `Процесор (честота)`, `Сторидж (Диск)`, `Памет`, `Камера`, `Видео карта`, `Операционна система`, `Bluetooth`, `Мрежа`, `Батерия`, `Сензори`, `Размер`, `Тегло (нето)`, `Гаранционен срок`) VALUES
